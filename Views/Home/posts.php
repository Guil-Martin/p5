    ...
    foreach (array_chunk($Posts, 3, true) as $array) {
        ...
        <div class="content_single col-sm-4" cont="<?php echo WEBROOT . 'gallery/gallerySingle/' . $image['postId'] ?>">
            ...
            <div class="imgContainer">
                ...
                <img class="image img-fluid" src="<?php echo WEBROOT . 'images/gallery/' . $image['imgThumbnail'] ?>" alt="<?php $image['imgTitle'] ?>">
                ...
                <div class="userName p-2">
                    <div class="">
                        <img width="25" src="<?php echo WEBROOT . 'images/users/' . $image["avatar"] ?>" alt="<?php echo $image["author"] ?>" class="img-fluid">
                ...
                <div class="stats text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="views col">
                            ...
                            <small class="p1-1"><?php echo shortNumber($image['views']) ?></small>
                        </div>
                        ...
                        <div class="likes col">
                            ...
                            <small class="pl-1"><?php echo shortNumber($image['likes']) ?></small>
                        </div>
                        ...
                        <div class="coms col">
                            ...
                            <small class="pl-1"><?php echo shortNumber($image['comments']) ?></small>
                        </div>
    ...
    foreach (array_chunk($Posts, 3, true) as $array) {
        ...
        <div class="content_single btn col-sm-4" cont="<?php echo WEBROOT . "news/newsSingle/" . $new['postId'] ?>">
            ...
            <div class="postContainer bg-dark">
                ...
                <div class="userName p-2">
                    <div class="">
                        <img width="25" src="<?php echo WEBROOT . 'images/users/' . $new["avatar"] ?>" alt="<?php echo $new["author"] ?>" class="img-fluid">
                ...
                <div class="stats text-center">
                    ...
                    <div class="views col">
                        ...
                        <small class="pl-1"><?php echo  shortNumber($new['views']) ?></small>
                    </div>
                    ...
                    <div class="likes col">
                        ...
                        <small class="pl-1"><?php echo  shortNumber($new['likes']) ?></small>
                    </div>
                    ...
                    <div class="coms col">
                        ...
                        <small class="pl-1"><?php echo shortNumber($new['comments']) ?></small>
                    </div>
