...
<div class="row">
    <div class="col text-center">
        <img width="100px" height="100px" src="<?php echo WEBROOT . 'images/users/' . $User->getAvatar() ?>" alt="<?php echo $User->getUserName() ?>" class="img-fluid">
...
<?php 
    ...
    <div class="row mb-2">
        ...
        <div class="container-fluid collapse bg-secondary" id="modTools">
            <div class="row">
                <button class="postContent col-sm-3 btn btn-primary text-left"
                cont="<?php echo WEBROOT . 'news/newsCreate/' . $User->getId() ?>" type="button">
                ...
                <span class="pl-1">Ajout - Nouvelle</span></button>

                <button class="postContent col-sm-3 btn btn-primary text-left"
                cont="<?php echo WEBROOT . 'gallery/galleryCreate/' . $User->getId() ?>" type="button" data-toggle="modal" data-target=".bd-example-modal-lg" >
                ...
                <span class="pl-1">Ajout - Image</span></button>

                <button class="postContent col-sm-3 btn btn-primary text-left"
                cont="<?php echo WEBROOT . 'users/profileEdit/' . $User->getId() ?>" type="button" data-toggle="modal" data-target=".bd-example-modal-lg" >
                ...
                <span class="pl-1">Editer Profil</span></button>

                <a href="<?php echo WEBROOT . 'users/logout'?>" class="col-sm-3 btn btn-danger">Déconnexion</a>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <button class="userPageTabs col-sm btn btn-secondary" cont="<?php echo WEBROOT . 'news/news/' . $User->getId() ?>" id="Nouvelles" aria-label="Nouvelles" title="Nouvelles">
            ...
            <span class="pl-1">Nouvelles<span>
        </button>

        <button class="userPageTabs col-sm btn btn-secondary" cont="<?php echo WEBROOT . 'users/profile/' . $User->getId() ?>" id="Profil" aria-label="Profil" title="Profil">
            ...
            <span class="pl-1">Profil<span>
        </button>

    </div>

    <div class="row">
        <div class="userPageContent col mt-4">
