...
?>
    ...
    <div class = "row mt-3">
        <div class = "col-md">
            <h2 class="text-center"><p><?php echo $Image->getImgTitle() ?></p></h2>
        </div>
    </div>
        ...
        <div class="col-md">
            ...
            <div class="mb-3 mt-3 d-flex">
                ...
                <div class="h-25 ml-auto">
                    ...
                    ?>
                    <button class="like btn btn-sm <?php echo !empty($ImageLiked) ? 'btn-danger' : 'btn-secondary' ?>" cont="<?php echo WEBROOT . 'gallery/likeImage/' . $Image->getId() . '/' . $User->getId() ?>">
                        <span>J'aime</span>
                    </button>
                    <?php
                    }
    ...
    <div class="row border-bottom border-light">
        <div class="col-md">
            ...
            if (empty($Owner) && !empty($User)) {?>
                ...
                <button class="btn btn-light mb-2" type="button" data-toggle="collapse" data-target="#comForm" aria-expanded="false" aria-controls="comForm">
                ...
                <div class="collapse" id="comForm">
                    <div class="row">                    
                        ...
                        <form id="validateForm" action="" cont="<?php echo WEBROOT . 'gallery/gallerySingle/' . $Image->getId() . '/' . $User->getId() ?>">
    ...
    <div class="row">
        <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">   
            ...
            <div class="commentBox border border-light bg-dark p-2 mt-2">
                ...
                <div class="d-flex mt-2">
                    <div class="ml-auto">
                        <div class="buttons">
                            ...
                            if (!empty($User)) {
                            ?>   
                            <button class="like btn btn-sm <?php echo !empty($com['likedComment']) ? 'btn-danger' : 'btn-secondary' ?>" cont="<?php echo WEBROOT . 'gallery/likeComment/' . $com['id'] . '/' . $Image->getId() . '/' . $User->getId() ?>">
                                <svg class="bi bi-heart-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
                                </svg>
                                J'aime
                ...
                <div class="sup">
                    <button class="delCom btn btn-danger" aria-label="Supprimer" title="Supprimer" cont="<?php echo WEBROOT . "gallery/delComment/" . $com["id"] . "/" . $Image->getId() . '/' . $User->getId() ?>">
