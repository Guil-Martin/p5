...
foreach (array_chunk($News, 3, true) as $array) {
    ...
    <div class="content_single col-sm-4 p-1" cont="<?php echo WEBROOT . "news/newsSingle/" . $new->getId() ?>">
            ...
            <div class="stats text-center">
                ...
                <div class="row">
                    ...
                    <div class="views col">
                        ...
                        <small class="pl-1"><?php echo $new->getViews() ?></small>
                    </div>
                    ...
                    <div class="likes col">
                        ...
                        <small class="pl-1"><?php echo $new->getLikes() ?></small>
                    </div>
                    ...
                    <div class="coms col">
                        ...
                        <small class="pl-1"><?php echo $new->getComments() ?></small>
                    </div>
