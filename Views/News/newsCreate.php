...
<form enctype="multipart/form-data" id="validateForm" class="mb-3" action="" cont="<?php echo WEBROOT . 'news/newsCreate/' . $_SESSION['userId'] ?>">
    ...
    <div class="form-group">
		<label for="avatar" aria-label="Avatar" title="Avatar">Optionnel - Avatar</label>
